...
using `itertools.combinations_with_replacement` but I felt
unnecessary, for the sake of simplicity.
...
The goal, however, is to do it in Clojure. After about a dozen tries,
