...
land; I maintain a pretty convoluted emacs config for a few years now.

The first challenge, I first solved it using Python's for loop.
...
The actual goal, however, is to do it in clojure. I also want to
implement the combination function on my own.
